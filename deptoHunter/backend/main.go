...
import (
	...
	"github.com/SantosFarias10/deptoHunter/scraper"
)
...
func main() {
	...
	urlArgenProp := "https://www.argenprop.com/departamentos/alquiler/cordoba-arg"
	go scraper.ScrapearSitio(urlArgenProp)
